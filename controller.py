...
def f3():
    ...
    db.session.add_all([student18, student19, student20, student21, student22, student23, student24, student25])
    db.session.commit()
    return jsonify({"status": "25 Studis mit 123456 erstellt."})
...
def f4():
    ...
    db.session.add_all([student26, student27, student28, student29, student30, student31, student32, student33, student34])
    db.session.commit()
    return jsonify({"status": "34 Studis mit 123456 erstellt."})
...
def f5():
    ...
    db.session.add_all([student35, student36, student37, student38, student39, student40, student41, student42])
    db.session.commit()
    return jsonify({"status": "42 Studis mit 123456 erstellt."})
...
def f6():
    ...
    db.session.add_all([student43, student44, student45, student46, student47, student48, student49, student50])
    db.session.commit()
